...
@section('content')
    <div class="px-6 min-h-screen h-full">
            ...
            <div class="flex pb-3">
                ...
                <div class="w-full text-white mt-4 lg:p-0 p-4">
                    <div class="flex flex-col">
                        <h1 class="font-semibold truncate">{{ $comment->user->name }}</h1>
                        <small class="text-sky-400 text-[0.6rem] my-1">{{ $comment->created_at->diffForhumans() }}</small>
                        <div class="my-2">
        ...
        <div>
            ...
            <div class="max-w-[835px] mx-auto mt-7">
                ...
                <div class="mt-5 ">
                    ...
                    {{-- <div class="mt-5 min-h-screen relative h-full w-full"> --}}

                    {{-- @include('components.comment.comment') --}}

                    {{-- <div class="fixed bottom-4 right-4 lg:right-14 ">
                        <div class="p-3 rounded-full bg-lime-500">
                            <a href="#">top</a>
                        </div>
                    </div> --}}
                </div>
